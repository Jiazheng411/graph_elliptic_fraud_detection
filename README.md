...
### Data split
* data_split.py - data split script  1-29 train, 31-24 valid, 35-49 test. But later in experiment combined tran and valid
...
All experiment conduct using combined train + val as train (1-34), and test as test (35- 49), the same setting as in the paper
...
* gcn_paper_reproduction.py - gcn model and training according to paper setting
    ...
    * Train and test are separate graph
